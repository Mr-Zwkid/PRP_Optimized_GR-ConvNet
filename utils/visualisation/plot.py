...
def save_results(rgb_img, grasp_q_img, grasp_angle_img, depth_img=None, no_grasps=1, grasp_width_img=None):
    ...
    # plot = ax.imshow(grasp_q_img, cmap='jet', vmin=0, vmax=1)
    plot = ax.imshow(grasp_q_img, cmap='inferno')
    ...
    # plot = ax.imshow(grasp_angle_img, cmap='hsv', vmin=-np.pi / 2, vmax=np.pi / 2)
    plot = ax.imshow(grasp_angle_img, cmap='terrain', vmin=-np.pi / 2, vmax=np.pi / 2)
    ...
    # plot = ax.imshow(grasp_width_img, cmap='jet', vmin=0, vmax=100)
    plot = ax.imshow(grasp_width_img, cmap='plasma', vmin=0, vmax=100)
